...
public class ScriptableDataSourceEditor extends CommonDialog
{
  ...
  protected void updateComponents()
  {
    ...
    initScriptTextArea.setSyntaxEditingStyle(mapLanguageToSyntaxHighlighting((String) languageField.getSelectedValue()));
    shutdownScriptTextArea.setSyntaxEditingStyle(mapLanguageToSyntaxHighlighting((String) languageField.getSelectedValue()));
