...
public class LookAndFeelStep extends AbstractWizardStep
{
  ...
  private static final String LOOK_AND_FEEL_STEP_OVERLAY = "org/pentaho/reporting/engine/classic/wizard/ui/xul/res/look_and_feel_step_Overlay.xul"; //$NON-NLS-1$
  ...
  private boolean validateStep()
  {
    ...
    { // This is where we check for a selected template
      return true;
    }
