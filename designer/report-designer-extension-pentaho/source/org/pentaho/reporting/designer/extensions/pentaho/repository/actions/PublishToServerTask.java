...
public class PublishToServerTask implements AuthenticatedServerTask
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      selectFileForPublishTask.setPublishPassword(oldPublishPassword);
      ...
      loginData.setOption("#publishPassword", selectFileForPublishTask.getPublishPassword());
      ...
      PublishUtil.publish(data, selectedReport, loginData, selectFileForPublishTask.getPublishPassword());
