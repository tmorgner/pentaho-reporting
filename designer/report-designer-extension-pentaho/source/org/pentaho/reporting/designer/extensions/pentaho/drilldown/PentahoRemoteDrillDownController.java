 ...
 */
public class PentahoRemoteDrillDownController extends DefaultXulDrillDownController
{
  ...
  public void init(final ReportDesignerContext reportDesignerContext, final DrillDownModel model)
  {
    ...
    final DrillDownProfile[] drillDownProfileByGroup =
        DrillDownProfileMetaData.getInstance().getDrillDownProfileByGroup("pentaho");
