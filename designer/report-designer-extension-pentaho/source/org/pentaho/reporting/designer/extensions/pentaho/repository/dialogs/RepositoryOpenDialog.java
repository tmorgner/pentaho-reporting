...
public class RepositoryOpenDialog extends CommonDialog
{
  ...
  protected class LevelUpAction extends AbstractAction
  {
    ...
    {
      putValue(Action.SHORT_DESCRIPTION, Messages.getInstance().getString("RepositoryPublishDialog.LevelUpAction.Description"));
  ...
  protected class BrowseRepositoryAction extends AbstractAction
  {
    ...
    {
      putValue(Action.SHORT_DESCRIPTION, Messages.getInstance().getString("RepositoryPublishDialog.BrowseRepositoryAction.Description"));
      final URL location = RepositoryOpenDialog.class.getResource
    ...
    public void actionPerformed(final ActionEvent e)
    {
      ...
      final RepositoryTreeDialog treeDialog = new RepositoryTreeDialog
          (RepositoryOpenDialog.this, isCreateFolderAllowed());
      treeDialog.pack();
      SwingUtil.centerDialogInParent(treeDialog);
      try
      {
