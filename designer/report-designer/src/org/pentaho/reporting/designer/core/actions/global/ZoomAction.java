...
public abstract class ZoomAction extends AbstractReportContextAction implements ToggleStateAction
{
  ...
  protected ZoomAction(final int percentage)
  {
    ...
    putValue(Action.SHORT_DESCRIPTION, ActionMessages.getString("ZoomAction.Description", Integer.valueOf(percentage)));
    ...
    if (percentage == 50)
    {
    	//putValue(Action.NAME, ActionMessages.getString("ZoomAction.Text") + " 50");
