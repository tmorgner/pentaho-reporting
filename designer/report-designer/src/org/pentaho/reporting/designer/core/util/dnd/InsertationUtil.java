...
{
  private static final String SUBREPORT_BANDED_HINT = "subreport-banded-hint";
  ...
  public static boolean isDeleteAllowed(final ReportRenderContext context, final Object data)
  {
    ...
    {
      if (data == context.getReportDefinition().getDataFactory())
      {
        return false;
      }
      return true;
                              ...
                              final Object fromClipboard)
  {
    ...
    if (rawLeadSelection instanceof Group)
    {
      try
      {
