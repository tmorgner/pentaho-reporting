...
public class BasicLinkPanel extends JPanel
{
  ...
  public BasicLinkPanel()
  {
    ...
    theUpperMainPanel.setBorder(BorderFactory.createTitledBorder(Messages.getString("HyperlinkPropertiesPane.Link")));   
    ...
    theMidMainPanel.setBorder(BorderFactory.createTitledBorder(Messages.getString("HyperlinkPropertiesPane.Title")));
    ...
    theBottomMainPanel.setBorder(BorderFactory.createTitledBorder(Messages.getString("HyperlinkPropertiesPane.Window")));
  ...
  public void commitValues(final ElementStyleSheet styleSheet, final Map styleExpressions)
  {
