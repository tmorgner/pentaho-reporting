    ...
    implements ReportElementEditorContext, CellEditorListener
{
  ...
  public Point2D normalize(final Point2D e)
  {
    ...
    final Point2D o = new Point2D.Double();
    o.setLocation(x, y);
    return o;
  }
  ...
  protected void paintComponent(final Graphics g)
  {
    ...
    for (int i = 0; i < renderers.length; i++)
    {
      ...
      renderer.validate(getRenderContext(), getRenderContext().getZoomModel().getZoomAsPercentage());
  ...
  protected void paintGrid(final Graphics2D g2d)
  {
    if (WorkspaceSettings.getInstance().isShowGrid())
    {
      ...
      for (double w = gridSize; w < gridWidth; w += gridSize)
      {
        ...
        {
          g2d.setColor(getPrimaryGridColor());
        }
        else
        {
          g2d.setColor(getSecondaryGridColor());
        }
        horizontalLineCount++;
  ...
  public Color getSecondaryGridColor()
  {
  ...
  public Color getPrimaryGridColor()
  {
    return primaryGridColor;
  }

  public void setPrimaryGridColor(final Color primaryGridColor)
  {
    if (primaryGridColor == null)
    {
      throw new NullPointerException();
    }
