...
public final class ShowPreviewPaneAction extends AbstractDesignerContextAction implements ToggleStateAction
{
  ...
  public void setSelected(final boolean selected)
  {
    ...
    firePropertyChange(ToggleStateAction.SELECTED, oldValue, selected);
  ...
  protected void updateDesignerContext(final ReportDesignerContext oldContext, final ReportDesignerContext newContext)
  {
    if (oldContext != null)
    {
      oldContext.getView().removePropertyChangeListener(ReportDesignerView.PREVIEW_VISIBLE_PROPERTY, selectionUpdateListener);
    ...
    if (newContext != null)
    {
      newContext.getView().addPropertyChangeListener(ReportDesignerView.PREVIEW_VISIBLE_PROPERTY, selectionUpdateListener);
