...
import org.pentaho.reporting.engine.classic.core.designtime.AdvancedPropertyEditor;
...
public class ResourcePropertyEditor implements AdvancedPropertyEditor
{
  ...
  /**
   * Indicates that this property editor can not be set as text since it it more complicated (it has to
   * support linking vs. embedding.
   */
