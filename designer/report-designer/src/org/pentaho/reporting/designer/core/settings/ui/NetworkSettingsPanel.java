...
public class NetworkSettingsPanel extends JPanel implements SettingsPlugin
{
  private class EditExceptionsAction extends AbstractAction
  {
    ...
    {
      final Window window = SwingUtil.getWindowAncestor(NetworkSettingsPanel.this);
  ...
  public NetworkSettingsPanel()
  {
    ...
    radioButtonUserProxy = new JRadioButton(SettingsMessages.getInstance().getString("ProxySettingsPanel.userProxy"));
