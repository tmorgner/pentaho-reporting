...
import org.pentaho.reporting.designer.core.util.table.expressions.ExpressionCellEditor;
...
public class ElementMetaDataTable extends JTable implements DesignerContextComponent
{
  ...
  public ElementMetaDataTable()
  {
    ...
    expressionsCellEditor = new ExpressionCellHandler(new ExpressionCellEditor());
    expressionsCellRenderer = new ExpressionCellHandler(new ExpressionCellEditor());
