    ...
    implements ToggleStateAction, SettingsListener
{
  ...
  public ElementDisplayStyleValuesAction()
  {
    ...
    putValue(Action.ACCELERATOR_KEY, ActionMessages.getOptionalKeyStroke("ElementDisplayStyleValuesAction.Accelerator"));
  ...
  {
    selected = WorkspaceSettings.getInstance().isElementsDisplayValues();
    return selected;
  }
