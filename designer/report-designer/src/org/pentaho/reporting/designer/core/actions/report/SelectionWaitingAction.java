    ...
    implements ToggleStateAction
{
  ...
  private class SelectionWaitingHandler implements PropertyChangeListener
  {
    ...
    {
      firePropertyChange(ToggleStateAction.SELECTED, evt.getOldValue(), evt.getNewValue());
    }
  }
  ...
  protected void updateDesignerContext(final ReportDesignerContext oldContext, final ReportDesignerContext newContext)
  {
    ...
    if (oldContext != null)
    {
      oldContext.removePropertyChangeListener(ReportDesignerContext.SELECTION_WAITING_PROPERTY, selectionWaitingHandler);
    }
    if (newContext != null)
    {
  ...
  public boolean isSelected()
  {
    ...
    return activeContext.isSelectionWaiting();
  }
