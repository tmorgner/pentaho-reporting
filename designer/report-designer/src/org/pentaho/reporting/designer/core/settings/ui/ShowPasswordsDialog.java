...
public class ShowPasswordsDialog extends CommonDialog
{
  ...
  {
    final JPanel buttonsCarrierPanel = super.createButtonsPane();
    final JPanel buttonsPanel = (JPanel) buttonsCarrierPanel.getComponent(0);
    buttonsPanel.add(new JButton(new ShowPasswordsAction()));
