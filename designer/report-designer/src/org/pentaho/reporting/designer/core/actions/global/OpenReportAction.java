...
{
  private static final String FAILED_TO_OPEN_TITLE = ActionMessages.getString("FailedToOpen.Error.Title");
  private static final String FAILED_TO_OPEN_MESSAGE = ActionMessages.getString("FailedToOpen.Error.Message");
                                ...
                                final ReportDesignerContext context)
  {
    ...
    BackgroundCancellableProcessHelper.executeProcessWithCancelDialog(loadThread, null, context.getParent());
    ...
    else
    {
      ...
      {
        ExceptionDialog.showExceptionDialog(context.getParent(), FAILED_TO_OPEN_TITLE,
            FAILED_TO_OPEN_MESSAGE, exception);
