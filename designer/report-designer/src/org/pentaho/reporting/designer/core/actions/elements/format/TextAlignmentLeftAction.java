...
public final class TextAlignmentLeftAction extends AbstractElementSelectionAction implements ToggleStateAction
{
  ...
  {
    putValue(Action.NAME, ActionMessages.getString("TextAlignmentLeftAction.Text"));
    putValue(Action.SHORT_DESCRIPTION, ActionMessages.getString("TextAlignmentLeftAction.Description"));
