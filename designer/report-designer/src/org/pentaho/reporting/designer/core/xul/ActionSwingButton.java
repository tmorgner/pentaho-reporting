...
public class ActionSwingButton extends SwingButton implements DesignerContextComponent
{
  ...
  private class ActionChangeHandler implements PropertyChangeListener
  {
    ...
    public void propertyChange(final PropertyChangeEvent event)
    {
      try
      {
        ...
        if (propertyName.equals(ActionDowngrade.ACCELERATOR_KEY))
        {
          ...
          final Object o = actionImpl.getValue(ActionDowngrade.ACCELERATOR_KEY);
        ...
        else if (propertyName.equals(ActionDowngrade.MNEMONIC_KEY))
        {
          final Object o = actionImpl.getValue(ActionDowngrade.MNEMONIC_KEY);
          if (o != null)
          {
  ...
  protected void installAction(final Action newAction)
  {
    if (newAction != null)
    {
      ...
      final Object o = newAction.getValue(ActionDowngrade.ACCELERATOR_KEY);
      if (o instanceof KeyStroke)
      {
        final KeyStroke k = (KeyStroke) o;
