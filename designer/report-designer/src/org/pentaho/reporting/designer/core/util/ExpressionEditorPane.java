...
import org.pentaho.reporting.designer.core.util.table.expressions.ExpressionComboBoxEditor;
...
public class ExpressionEditorPane extends JPanel
{
  ...
  private class ExtendedEditorAction extends AbstractAction
  {
    ...
    {
      final Window w = SwingUtil.getWindowAncestor(ExpressionEditorPane.this);
