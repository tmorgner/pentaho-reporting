...
public class ElementFormatDialog extends CommonDialog
{
  ...
  {
    final EditableStyleSheet styleSheet = new EditableStyleSheet(element);
    final Map editableStyleExpressions;
    ...
    {
      editableStyleExpressions = new HashMap(styleExpressions);
    }
