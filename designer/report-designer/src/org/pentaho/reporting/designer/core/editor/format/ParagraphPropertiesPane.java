...
public class ParagraphPropertiesPane extends JPanel
{
  ...
  public ParagraphPropertiesPane()
  {
    ...
    textToTextPanel.setBorder(BorderFactory.createTitledBorder(Messages.getString("ParagraphPropertiesPane.TextToTextAlignment")));
    ...
    whitespacePanel.setBorder(BorderFactory.createTitledBorder(Messages.getString("ParagraphPropertiesPane.WhitespaceProcessing")));
  ...
  public void commitValues(final ElementStyleSheet styleSheet)
  {
    ...
    styleSheet.setStyleProperty(TextStyleKeys.LINEHEIGHT, BorderPropertiesPane.parseLength(lineHeightField.getText()));
