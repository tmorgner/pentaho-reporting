...
public class MailDefinitionBundleWriter
{
  ...
  public void writeMailDefinition(final WriteableDocumentBundle documentBundle,
                                  final MailDefinition report,
  ...
  public static void writeReportToZipFile(final MailDefinition report, final File file)
  ...
  public static void writeReportToZipStream(final MailDefinition report, final OutputStream out)
      throws IOException, BundleWriterException, ContentIOException
  {
    if (report == null)
    {
  ...
  public static void writeReportToDirectory(final MailDefinition report, final File file)
      throws IOException, BundleWriterException, ContentIOException
  {
    if (report == null)
    {
