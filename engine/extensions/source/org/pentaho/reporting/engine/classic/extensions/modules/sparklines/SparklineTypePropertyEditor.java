 ...
 */
public class SparklineTypePropertyEditor implements PropertyEditor
{
  ...
  private boolean isValidType(final Object barodeType)
  {
    if ("line".equals(barodeType))
    {
      return true;
    }
    if ("bar".equals(barodeType))
    {
      return true;
    }
    if ("pie".equals(barodeType))
    {
      return true;
    }
