...
/**
 * This class is the Element type implementation of Sparkline line graph.<br/> This Element type only allows the
 * configuration line color and the spacing between data points.
 *
...
public class LineSparklineType extends ContentType
{
  ...
  public ElementMetaData getMetaData()
  {
    if (elementType == null)
    {
      elementType = ElementTypeRegistry.getInstance().getElementType("line-sparkline");
    }
    return elementType;
  }
