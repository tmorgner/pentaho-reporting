...
/**
 * The report-designer format has no DTD and uses the same root element as the simple report format.
 * Therefore this parser only gets active if explicitly specified.
 *
