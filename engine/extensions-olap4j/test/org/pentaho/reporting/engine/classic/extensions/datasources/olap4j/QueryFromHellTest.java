 ...
 */
public class QueryFromHellTest extends TestCase
{
  /**
  ...
  public QueryFromHellTest()
  {
  }

  public QueryFromHellTest(final String s)
  {
    super(s);
  }
  ...
  public void testQuery1() throws SQLException, IOException
  {
  ...
  public void testQuery2() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_2, ps);
    compareLineByLine("query2-results.txt", sw.toString());
  }

  public void testQuery3() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_3, ps);
    compareLineByLine("query3-results.txt", sw.toString());
  }
  public void testQuery3a() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_3A, ps);
    compareLineByLine("query3a-results.txt", sw.toString());
  }

  public void testQuery4() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_4, ps);
    compareLineByLine("query4-results.txt", sw.toString());
  }

  public void testQuery5() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_5, ps);
    compareLineByLine("query5-results.txt", sw.toString());
  }

  public void testQuery6() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_6, ps);
    compareLineByLine("query6-results.txt", sw.toString());
  }

  public void testQuery7() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_7, ps);
    compareLineByLine("query7-results.txt", sw.toString());
  }

  public void testQuery8() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_8, ps);
    compareLineByLine("query8-results.txt", sw.toString());
  }

  public void testQuery9() throws SQLException, IOException
  {
    final ByteArrayOutputStream sw = new ByteArrayOutputStream();
    final PrintStream ps = new PrintStream(sw);
    performQueryTest(QUERY_9, ps);
    compareLineByLine("query9-results.txt", sw.toString());
  }
  ...
  private void compareLineByLine(final String sourceFile, final String resultText) throws IOException
  {
    ...
    final BufferedReader compareReader = new BufferedReader(new InputStreamReader
        (ObjectUtilities.getResourceRelativeAsStream(sourceFile, QueryFromHellTest.class)));
    try
    {
      int line = 1;
  ...
  protected void performQueryTest(final String query, final PrintStream out) throws SQLException
  {
    ...
    try
    {
      ...
      final DenormalizedMDXTableModel tableModel = new DenormalizedMDXTableModel(new QueryResultWrapper(statement, cellSet));
      try
      {
