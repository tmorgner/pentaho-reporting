 ...
 */
public class BandedQueryFromHellTest extends TestCase
{
  /**
  ...
  public BandedQueryFromHellTest()
  {
  }

  public BandedQueryFromHellTest(final String s)
  {
    super(s);
  }
  ...
  public void testQuery1() throws Exception
  {
    ...
    compareLineByLine("query1-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery2() throws Exception
  {
    ...
    compareLineByLine("query2-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery3() throws Exception
  {
    ...
    compareLineByLine("query3-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery3a() throws Exception
  {
    ...
    compareLineByLine("query3a-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery4() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query4-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery5() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query5-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery6() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query6-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery7() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query7-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery8() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query8-banded-results.txt", sw.toString());
  }
  ...
  public void testQuery9() throws SQLException, IOException, ReportDataFactoryException
  {
    ...
    compareLineByLine("query9-banded-results.txt", sw.toString());
  }
  ...
  protected void performQueryTest(final String query, final PrintStream out) throws SQLException, ReportDataFactoryException
  {
    ...
    try
    {
      ...
      final BandedMDXTableModel tableModel = new BandedMDXTableModel(new QueryResultWrapper(statement, cellSet), -1);
      try
      {
