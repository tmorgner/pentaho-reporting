...
public abstract class AbstractMDXDataFactoryBundleWriteHandler
{
      ...
      throws IOException, BundleWriterException
  {
    ...
    if (StringUtils.isEmpty(roleField) == false)
    {
    ...
    if (StringUtils.isEmpty(jdbcUserField) == false)
    {
    ...
    if (StringUtils.isEmpty(jdbcPasswordField) == false)
    {
      ...
      throws IOException, BundleWriterException
  {
    ...
    final OlapConnectionProviderWriteHandler handler =
        (OlapConnectionProviderWriteHandler) ObjectUtilities.loadAndInstantiate
            (value, DenormalizedMDXDataFactoryBundleWriteHandler.class, OlapConnectionProviderWriteHandler.class);
    if (handler != null)
    {
