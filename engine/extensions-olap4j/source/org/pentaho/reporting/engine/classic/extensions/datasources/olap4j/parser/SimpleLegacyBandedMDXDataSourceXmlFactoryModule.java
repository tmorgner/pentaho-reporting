 ...
 */
public class SimpleLegacyBandedMDXDataSourceXmlFactoryModule implements XmlFactoryModule
{
  public SimpleLegacyBandedMDXDataSourceXmlFactoryModule()
  {
  }
  ...
  public int getDocumentSupport(final XmlDocumentInfo documentInfo)
  {
    ...
    if (rootNamespace != null && rootNamespace.length() > 0)
    {
      ...
      else if ("simple-legacy-banded-mdx-datasource".equals(documentInfo.getRootElement()))
      {
  ...
  {
    return new SimpleLegacyBandedMDXDataSourceReadHandler();
  }
