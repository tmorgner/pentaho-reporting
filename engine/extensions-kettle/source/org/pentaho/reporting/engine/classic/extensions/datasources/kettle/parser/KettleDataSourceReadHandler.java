    ...
    implements DataFactoryReadHandler
{
      ...
      throws SAXException
  {
    ...
    if (tagName.equals("query-repository"))
    {
      final AbstractKettleTransformationReadHandler queryReadHandler = new KettleTransFromRepositoryReadHandler();
      queries.add(queryReadHandler);
      return queryReadHandler;
    }
    return null;
  ...
  protected void addQueryHandler(final AbstractKettleTransformationReadHandler readHandler)
  {
