 ...
 */
public class KettleDataFactory implements DataFactory, Cloneable
{
  private transient ResourceManager resourceManager;
  private transient ResourceKey contextKey;
  private HashMap<String, KettleTransformationProducer> queries;
  private transient KettleTransformationProducer currentlyRunningQuery;

  public KettleDataFactory()
  {
    queries = new HashMap<String, KettleTransformationProducer>();
  }
  ...
  {
    return (KettleDataFactory) clone();
  }
  ...
  public Object clone()
  {
    try
    {
      ...
      df.queries = (HashMap<String, KettleTransformationProducer>) queries.clone();
  ...
  public Object getQueryHash(final String queryName)
  {
    ...
    return transformationProducer.getQueryHash(resourceManager, contextKey);
  }
}
