...
/**
 * An implementation variant of the {@link org.jfree.data.xy.TableXYDataset} where every series
 * shares the same x-values (required for generating stacked area charts).
 * This implementation uses a {@link org.jfree.data.DefaultKeyedValues2D} Object as backend
 ...
 * <p/>
 * This class also implements the {@link org.jfree.data.xy.IntervalXYDataset} interface, but this
    ...
    PublicCloneable
{
  ...
  /**
   * Adds a data item to this dataset and sends a {@link org.jfree.data.general.DatasetChangeEvent}
