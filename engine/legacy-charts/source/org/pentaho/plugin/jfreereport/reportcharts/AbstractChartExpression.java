...
public abstract class AbstractChartExpression extends AbstractExpression implements ChartExpression
{
  ...
  /**
   * Used for turning off outline in bar legend
   *
   * @deprecated Constants should be named all uppercase.
   */
  protected static final Stroke EmptyStroke = EMPTY_STROKE;
  ...
  protected JFreeChart loadChartFromCache(final Object key)
  {
    ...
    final Object o = chartCache.get(key);
    if (o != null)
    {
      return (JFreeChart) o;
    }
  ...
  public Expression getInstance()
  {
    ...
    instance.chartCache = new HashMap<Object,JFreeChart>();
