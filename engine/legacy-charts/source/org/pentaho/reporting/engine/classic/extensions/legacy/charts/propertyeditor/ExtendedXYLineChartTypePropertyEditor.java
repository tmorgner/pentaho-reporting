...
public class ExtendedXYLineChartTypePropertyEditor implements PropertyEditor
{
  ...
  public void setValue(final Object value)
  {
    ...
    if (ExtendedXYLineChartExpression.DIFFERENCE_CHART_STR.equals(value))
    {
      this.value = ExtendedXYLineChartExpression.DIFFERENCE_CHART_STR;
    }
    else if (ExtendedXYLineChartExpression.STEP_AREA_CHART_STR.equals(value))
    {
      this.value = ExtendedXYLineChartExpression.STEP_AREA_CHART_STR;
    }
    else if (ExtendedXYLineChartExpression.STEP_CHART_STR.equals(value))
    {
      this.value = ExtendedXYLineChartExpression.STEP_CHART_STR;
    }
    else
    {
      this.value = null;
  ...
  {
    return new String[] { ExtendedXYLineChartExpression.STEP_AREA_CHART_STR,
        ExtendedXYLineChartExpression.STEP_CHART_STR, ExtendedXYLineChartExpression.DIFFERENCE_CHART_STR };
  }
