 ...
 */
public class LineStylePropertyEditor implements PropertyEditor
{
  ...
  public void setValue(final Object value)
  {
    ...
    if (AbstractChartExpression.LINE_STYLE_SOLID_STR.equals(value))
    {
      this.value = AbstractChartExpression.LINE_STYLE_SOLID_STR;
    }
    else if (AbstractChartExpression.LINE_STYLE_DOT_STR.equals(value))
    {
      this.value = AbstractChartExpression.LINE_STYLE_DOT_STR;
    }
    else if (AbstractChartExpression.LINE_STYLE_DASH_STR.equals(value))
    {
      this.value = AbstractChartExpression.LINE_STYLE_DASH_STR;
    }
    else if (AbstractChartExpression.LINE_STYLE_DASHDOT_STR.equals(value))
    {
      this.value = AbstractChartExpression.LINE_STYLE_DASHDOT_STR;
    }
    else if (AbstractChartExpression.LINE_STYLE_DASHDOTDOT_STR.equals(value))
    {
      this.value = AbstractChartExpression.LINE_STYLE_DASHDOTDOT_STR;
    }
    else
    {
      this.value = null;
  ...
  {
    return new String[]{AbstractChartExpression.LINE_STYLE_SOLID_STR,
        AbstractChartExpression.LINE_STYLE_DASH_STR,
        AbstractChartExpression.LINE_STYLE_DOT_STR,
        AbstractChartExpression.LINE_STYLE_DASHDOT_STR,
        AbstractChartExpression.LINE_STYLE_DASHDOTDOT_STR};
  }
