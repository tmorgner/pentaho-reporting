...
public class QueryFromHellTest extends TestCase
{
                                ...
                                final PrintStream out) throws SQLException, ReportDataFactoryException
  {
    ...
    try
    {
      ...
      try
      {
        // Construct a cachable table model, this verifies that it's possible 
        CachableTableModel model = new CachableTableModel(tableModel);
  ...
  {
    final QueryFromHellTest hellTest = new QueryFromHellTest();
    hellTest.setUp();
    hellTest.performQueryTest(QUERY_1, System.out);
    System.out.println();
    hellTest.performQueryTest(QUERY_2, System.out);
    System.out.println();
    hellTest.performQueryTest(QUERY_3, System.out);
    System.out.println();
    hellTest.performQueryTest(QUERY_3A, System.out);
    System.out.println();
