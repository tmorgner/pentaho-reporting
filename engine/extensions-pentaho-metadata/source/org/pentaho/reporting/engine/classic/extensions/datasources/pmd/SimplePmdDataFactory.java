 ...
 */
public class SimplePmdDataFactory implements DataFactory, Cloneable
{
  ...
  protected IMetadataDomainRepository getDomainRepository() throws ReportDataFactoryException
  {
    ...
    {
      domainRepository = connectionProvider.getMetadataDomainRepository(domainId, resourceManager, contextKey, xmiFile);
      if (domainRepository == null)
      {
