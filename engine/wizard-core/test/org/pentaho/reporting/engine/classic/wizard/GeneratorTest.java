...
public class GeneratorTest extends TestCase
{
  ...
  public void testCrosstab() throws Exception
  {
    ...
    final DefaultFlowController flowController = new DefaultFlowController
        (processingContext, report.getDataSchemaDefinition(), new ReportParameterValues(), null, false);
    ...
    final CrosstabRowGroup rowGroup = (CrosstabRowGroup) body2.getGroup();
    ...
    final CrosstabColumnGroup colGroup = (CrosstabColumnGroup) body3.getGroup();
