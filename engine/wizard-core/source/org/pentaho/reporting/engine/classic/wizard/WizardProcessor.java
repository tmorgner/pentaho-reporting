...
public class WizardProcessor implements ReportPreProcessor
{
  ...
  private static class UpdateHeaderTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      ...
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, "CachedWizardFormatData", groupDefinition.getHeader());
      }
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, "CachedWizardFieldData", groupDefinition);
      }
    }
  }
  ...
  private static class UpdateFooterTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_STYLING)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, "CachedWizardFormatData", groupDefinition.getFooter());
      }
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
  ...
  private static class UpdateDetailsTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      ...
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_STYLING)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, "CachedWizardFormatData", fieldDefinition);

        if (Boolean.TRUE.equals(e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.PRESERVE_USER_STYLING)))
        {
          ...
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_ITALICS) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_ITALICS, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(TextStyleKeys.UNDERLINED))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_UNDERLINE) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_UNDERLINE, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(TextStyleKeys.STRIKETHROUGH))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_STRIKETHROUGH) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_STRIKETHROUGH, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(TextStyleKeys.FONT))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_FONTFAMILY) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_FONTFAMILY, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(TextStyleKeys.FONTSIZE))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_FONTSIZE) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_FONTSIZE, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(ElementStyleKeys.PAINT))
          {
            ...
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_COLOR, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(ElementStyleKeys.BACKGROUND_COLOR))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_BACKGROUND_COLOR) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_BACKGROUND_COLOR, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(ElementStyleKeys.VALIGNMENT))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_VALIGNMENT) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_VALIGNMENT, Boolean.FALSE);
            }
          }
          if (styleSheet.isLocalKey(ElementStyleKeys.ALIGNMENT))
          {
            if (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_ALIGNMENT) != null)
            {
              e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ENABLE_STYLE_ALIGNMENT, Boolean.FALSE);
            }
          }
        }
      }
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, "CachedWizardFieldData", fieldDefinition);
      }
    }
  }
 ...
 */
  ...
  protected void setupDefaultPadding(final Band band, final Element detailElement)
  {
    ...
    final Object maybePaddingLeft = band.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.PADDING_LEFT);
    final Object maybePaddingBottom = band.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.PADDING_BOTTOM);
    final Object maybePaddingRight = band.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.PADDING_RIGHT);
