...
public class TextTest extends TestCase
{
  ...
  public void testTextNewline()
  {
    ...
    final RenderNode[] renderNodes =
        textFactory.createText(data, 0, length, defaultStyle, LegacyType.INSTANCE, new InstanceID(),
  ...
  public void testWhitespaceCollapse()
  {
    ...
    final int length = buffer.getLength();
    final ElementStyleSheet defaultStyle = element.getStyle();
    defaultStyle.setStyleProperty(TextStyleKeys.WHITE_SPACE_COLLAPSE, WhitespaceCollapse.DISCARD);
    final RenderNode[] renderNodes =
        textFactory.createText(data, 0, length, defaultStyle, LegacyType.INSTANCE, new InstanceID(),
            ReportAttributeMap.EMPTY_MAP);
    final RenderNode[] finishNodes = textFactory.finishText();
