...
/*
  ...
  private MasterReport createReport()
  {
    ...
    report.getItemBand().addElement(createNumberElement(0, "value", "I1"));
    report.getItemBand().addElement(createNumberElement(100, "fn", "I2"));
    report.getPageFooter().addElement(createNumberElement(0, "value", "P1"));
    report.getPageFooter().addElement(createNumberElement(100, "fn", "P2"));
    return report;
  }
