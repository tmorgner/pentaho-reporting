 ...
 */
public class Prd2324Test extends TestCase
{
  ...
  public Prd2324Test(final String s)
  {
    super(s);
  }
  ...
  public void testPageFooterMissing() throws IOException, ReportProcessingException
  {
    ...
    assertTrue("Found PageFooter", data.indexOf("PageFooter") >= 0);
    assertTrue("Found PageHeader", data.indexOf("PageHeader") >= 0);
    assertTrue("Found ReportFooter", data.indexOf("ReportFooter") >= 0);
    assertTrue("Found ReportHeader", data.indexOf("ReportHeader") >= 0);
