...
public class StaticDataSourceFactoryTest extends TestCase
{
  ...
  public void testDataFactory() throws ReportDataFactoryException
  {
    ...
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTest.class.getName() + "#createSimpleTableModel", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTest.class.getName() + "#createSimpleTableModel()", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTest.class.getName() + "#createParametrizedTableModel(parameter2,parameter1)", sdr));

    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName(), sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "#createSimpleTableModel", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "#createSimpleTableModel()", sdr));
    assertNotNull(sfd.queryData
    ...
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "(parameter1,parameter2)", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "(parameter1,parameter2)#createSimpleTableModel", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "(parameter1,parameter2)#createSimpleTableModel()", sdr));
    assertNotNull(sfd.queryData
        (StaticDataSourceFactoryTestSupport.class.getName() + "(parameter1,parameter2)#createParametrizedTableModel(parameter2,parameter1)",
            sdr));
  }
