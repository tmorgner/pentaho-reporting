...
public class LocalFontSpecGenerator
{
  public static void main(final String[] args) throws IOException
  {
    ...
    defaultTagDescription.addDefaultDefinition(null, false);
 ...
 */
  ...
  private static void writeRecord(final XmlWriter writer,
                                  final boolean bold,
                                  final boolean italics,
                                  FontRecord record,
                                  final Map<String, FontRecord> records) throws IOException
  {
