...
public class RightAlignmentProcessorTest extends TestCase
{
  private DebugOutputProcessorMetaData outputProcessorMetaData;
  private PageGrid pageGrid;

  public RightAlignmentProcessorTest()
  {
  }

  public RightAlignmentProcessorTest(final String name)
  {
    super(name);
  }
  ...
  protected void setUp() throws Exception
  {
    ...
    outputProcessorMetaData = new DebugOutputProcessorMetaData(ClassicEngineBoot.getInstance().getGlobalConfig());
  ...
  public void testSimpleCase()
  {
   ...
   // ModelPrinter.INSTANCE.print(next);
  }
