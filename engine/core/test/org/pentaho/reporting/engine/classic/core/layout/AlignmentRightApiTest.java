 ...
 */
public class AlignmentRightApiTest extends TestCase
{
  ...
  public void testAlignmentRight() throws Exception
  {
    ...
    final Band pageHeader = report.getPageHeader();
    pageHeader.getStyle().setStyleProperty(ElementStyleKeys.MINIMUMSIZE, new FloatDimension(0.0f, 10.0f));
    ...
    debugLayoutSystem.add(report.getPageHeader(), runtime, stateKey);
  ...
  public void testAlignmentRightFooterCase() throws Exception
  {
    ...
    SurveyScaleAPIDemoHandler handler = new SurveyScaleAPIDemoHandler();
    ...
    final ReportStateKey stateKey = new ReportStateKey();
    debugLayoutSystem.add(report.getPageFooter(), runtime, stateKey);
    debugLayoutSystem.endSection();

    debugLayoutSystem.validatePages();
    debugLayoutSystem.markDirty();
    debugLayoutSystem.validatePages();
    debugLayoutSystem.markDirty();
    debugLayoutSystem.validatePages();
    debugLayoutSystem.markDirty();
