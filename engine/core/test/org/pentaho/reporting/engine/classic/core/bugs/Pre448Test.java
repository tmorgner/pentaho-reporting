 ...
 */
public class Pre448Test extends TestCase
{
  public Pre448Test()
  {
  }

  public Pre448Test(final String s)
  {
    super(s);
  }
  ...
  {
    final URL target = Pre448Test.class.getResource("Pre-448.xml");
    ...
    final Band band = (Band) report.getReportHeader().getElement(3);
  ...
  public void testCanvasLayoutBox() throws Exception
  {
    ...
    final Band band = (Band) report.getReportHeader().getElement(2);
    debugLayoutSystem.add(band, runtime, stateKey);
  ...
  public void testBlockLayout() throws Exception
  {
    ...
    final Band band = (Band) report.getReportHeader().getElement(1);
    debugLayoutSystem.add(band, runtime, stateKey);
  ...
  public void testCanvasLayout() throws Exception
  {
    ...
    final Band band = (Band) report.getReportHeader().getElement(0);
    debugLayoutSystem.add(band, runtime, stateKey);
