 ...
 */
public class AlignmentJustifiedTest extends TestCase
{
  ...
  public AlignmentJustifiedTest()
  {
  }

  public AlignmentJustifiedTest(final String s)
  {
    super(s);
  }
  ...
  public void testAlignmentCenter() throws Exception
  {
    ...
    debugLayoutSystem.add(report.getReportHeader(), runtime, stateKey);
