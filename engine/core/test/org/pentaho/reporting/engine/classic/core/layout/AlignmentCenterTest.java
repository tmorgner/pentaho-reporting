 ...
 */
public class AlignmentCenterTest extends TestCase
{
  public AlignmentCenterTest()
  {
  }

  public AlignmentCenterTest(final String s)
  {
    super(s);
  }
  ...
  public void testAlignmentCenter() throws Exception
  {
    ...
    final URL target = AlignmentCenterTest.class.getResource("alignment-center.xml");
