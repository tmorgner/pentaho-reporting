...
public class Pre492Test extends TestCase
{
  ...
  {
    private DebugFlowOutputProcessor(final Configuration configuration)
    {
      super(configuration);
    }
  ...
  public void testRun() throws Exception
  {
    ...
    try
    {
      ...
      final DebugFlowOutputProcessor outputProcessor = new DebugFlowOutputProcessor(report.getConfiguration());
