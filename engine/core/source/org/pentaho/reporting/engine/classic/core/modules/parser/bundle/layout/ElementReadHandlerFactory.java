 ...
 */
public class ElementReadHandlerFactory extends AbstractReadHandlerFactory
{
  private static final String PREFIX_SELECTOR =
      "org.pentaho.reporting.engine.classic.core.modules.parser.bundle.element-factory-prefix.";

  private static ElementReadHandlerFactory readHandlerFactory;

  public static synchronized ElementReadHandlerFactory getInstance()
  {
  ...
  private ElementReadHandlerFactory()
  {
  }
