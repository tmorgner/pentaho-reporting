 ...
 */
public class LegacyType implements ElementType, RawDataSource
{
  ...
  public ElementMetaData getMetaData()
  {
    if (elementType == null)
    {
      elementType = ElementTypeRegistry.getInstance().getElementType("legacy-element");
    }
    return elementType;
  }
  ...
  public Object getValue(final ExpressionRuntime runtime, final Element element)
  {
    ...
    return element.getDataSource().getValue(runtime, element);
  }
