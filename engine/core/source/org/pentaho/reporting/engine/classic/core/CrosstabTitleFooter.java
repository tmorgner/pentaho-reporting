...
import org.pentaho.reporting.engine.classic.core.filter.types.bands.CrosstabTitleFooterType;
 ...
 */
public class CrosstabTitleFooter extends Band implements RootLevelBand
{
  /**
   ...
   */
  public CrosstabTitleFooter()
  {
    setElementType(new CrosstabTitleFooterType());
  ...
  {
    return CrosstabTitleFooter.EMPTY_SUB_REPORTS;
  }
