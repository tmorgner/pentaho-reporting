 ...
 */
public class CrosstabTitleFooterType implements SectionType
{
  public CrosstabTitleFooterType()
  {
  }
  ...
  {
    return ElementTypeRegistry.getInstance().getElementType("crosstab-title-footer");
  }
