...
public class DefaultDataAttributes implements DataAttributes
{
  ...
  public ConceptQueryMapper getMetaAttributeMapper(final String domain, final String name)
  {
    ...
    final ConceptQueryMapper attribute = (ConceptQueryMapper) mapperBackend.getAttribute(domain, name);
    if (attribute == null)
    {
  ...
  public Object clone() throws CloneNotSupportedException
  {
    ...
    o.valueBackend = (AttributeMap) valueBackend.clone();
    o.mapperBackend = (AttributeMap) mapperBackend.clone();
    return o;
  }
