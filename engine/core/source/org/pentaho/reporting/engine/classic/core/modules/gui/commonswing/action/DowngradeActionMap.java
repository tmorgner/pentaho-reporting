 ...
 * <p/>
 * This implementation does not implement the ActionMap interface of JDK 1.3 or higher to maintain the compatibility
 * with JDK 1.2 which does not know this interface.
 * <p/>
...
public class DowngradeActionMap
{
   ...
   *
   * @return the <code>ActionMap</code> that is the parent of this one, or null if this <code>ActionMap</code> has no
   *         parent
   */
   ...
   * current binding for <code>key</code>. <p>In most instances, <code>key</code> will be
  ...
  /**
   * Returns the binding for <code>key</code>, messaging the parent <code>ActionMap</code> if the binding is not
   * locally defined.
   *
  ...
  /**
   * Returns an array of the keys defined in this <code>ActionMap</code> and its parent. This method differs from
   * <code>keys()</code> in that this method includes the keys defined in the parent.
   *
