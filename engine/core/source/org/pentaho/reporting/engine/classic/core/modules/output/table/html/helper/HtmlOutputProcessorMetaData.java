...
public class HtmlOutputProcessorMetaData extends AbstractOutputProcessorMetaData
{
  ...
  public boolean isExtraContentElement(final StyleSheet style, final ReportAttributeMap attributes)
  {
    ...
    if (attributes.getAttribute(AttributeNames.Html.NAMESPACE, AttributeNames.Html.EXTRA_RAW_CONTENT) != null)
    {
      return true;
    }
    if (attributes.getAttribute(AttributeNames.Html.NAMESPACE, AttributeNames.Html.EXTRA_RAW_FOOTER_CONTENT) != null)
    {
      return true;
    }
    return false;
