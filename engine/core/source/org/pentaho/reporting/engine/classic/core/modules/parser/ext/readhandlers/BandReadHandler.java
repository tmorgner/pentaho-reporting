...
public class BandReadHandler extends ElementReadHandler
{
      ...
      throws SAXException
  {
    ...
    if (style.isLocalKey(BandLayoutManager.LAYOUTMANAGER))
    {
      final Object o = style.getStyleProperty(BandLayoutManager.LAYOUTMANAGER);
      if (o instanceof StackedLayoutManager)
      {
