 ...
 */
public class StyleReadHandlerFactory extends AbstractReadHandlerFactory
{
  private static final String PREFIX_SELECTOR =
      "org.pentaho.reporting.engine.classic.core.modules.parser.bundle.style-factory-prefix.";

  private static StyleReadHandlerFactory readHandlerFactory;

  public static synchronized StyleReadHandlerFactory getInstance()
  {
  ...
  private StyleReadHandlerFactory()
  {
  }

  protected Class getTargetClass()
  {
    return StyleReadHandler.class;
  }
}