...
public abstract class RenderBox extends RenderNode
{
  ...
  private boolean invalidWidowOrphanNode;
...
//          ("Thou shall not use the replace method to insert new elements!");
  ...
  protected void makeReusable()
  {
    ...
    orphanConstraintSize = 0;
    widowConstraintSize = 0;
    widowConstraintSizeWithKeepTogether = 0;
    restrictFinishClearOut = RestrictFinishClearOut.UNRESTRICTED;
    parentWidowContexts = 0;
  ...
  {
    return invalidWidowOrphanNode;
  }

  public void setInvalidWidowOrphanNode(final boolean invalidWidowOrphanNode)
  {
    this.invalidWidowOrphanNode = invalidWidowOrphanNode;
  }
