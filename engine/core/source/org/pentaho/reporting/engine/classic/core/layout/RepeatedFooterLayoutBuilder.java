...
/**
 * Todo: Document Me
 * Todo: Find out when the page started even is fired when exporting and when browsing ..
 *
...
public class RepeatedFooterLayoutBuilder implements LayoutBuilder
{
  ...
  public RepeatedFooterLayoutBuilder(final OutputProcessorMetaData metaData)
  {
