...
public class CSVProcessor extends AbstractReportProcessor
{
  private static class CSVDataOutputProcessor extends AbstractOutputProcessor
  {
    ...
    private CSVDataOutputProcessor(final Configuration config)
    {
      metaData = new GenericOutputProcessorMetaData(config, EXPORT_DESCRIPTOR);
    }
  ...
  public CSVProcessor(final MasterReport report,
      ...
      throws ReportProcessingException
  {
    super(report, new CSVDataOutputProcessor(report.getConfiguration()));
