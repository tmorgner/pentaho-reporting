 ...
 */
public class TextWrapPropertyEditor implements PropertyEditor
{
  ...
  public void setValue(final Object value)
  {
    ...
    if (TextWrap.NONE.equals(value))
    {
      this.value = TextWrap.NONE;
    }
    else if (TextWrap.WRAP.equals(value))
    {
      this.value = TextWrap.WRAP;
    }
    else
    {
      this.value = null;
  ...
  {
    if (TextWrap.WRAP.equals(value))
    {
      return TextWrap.class.getName() + ".WRAP";
    }
    else if (TextWrap.NONE.equals(value))
    {
  ...
  {
    return new String[]{
        TextWrap.NONE.toString(),
        TextWrap.WRAP.toString(),
    };
  }
