 ...
 */
public class ReportPreProcessorMetaDataCollection
{
  ...
  public ReportPreProcessorMetaDataCollection(final ReportPreProcessorMetaData[] expressionMetaData)
  {
    ...
    this.expressionMetaData = (ReportPreProcessorMetaData[]) expressionMetaData.clone();
  }

  public ReportPreProcessorMetaData[] getReportPreProcessorMetaData()
  {
    return (ReportPreProcessorMetaData[]) expressionMetaData.clone();
  }
}