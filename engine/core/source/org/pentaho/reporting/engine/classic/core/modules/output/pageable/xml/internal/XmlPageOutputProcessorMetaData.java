...
public class XmlPageOutputProcessorMetaData extends AbstractOutputProcessorMetaData
{
  ...
  {
    this(configuration, new AWTFontRegistry());
  }

  public XmlPageOutputProcessorMetaData(final Configuration configuration, final FontRegistry registry)
  {
    super(configuration, new DefaultFontStorage(registry));
    ...
    if ("true".equals(configuration.getConfigProperty(
        "org.pentaho.reporting.engine.classic.core.modules.output.pageable.xml.AssumeOverflowX")))
    {
      addFeature(OutputProcessorFeature.ASSUME_OVERFLOW_X);
    }
    if ("true".equals(configuration.getConfigProperty(
        "org.pentaho.reporting.engine.classic.core.modules.output.pageable.xml.AssumeOverflowY")))
    {
      addFeature(OutputProcessorFeature.ASSUME_OVERFLOW_Y);
    }
    if ("true".equals(configuration.getConfigProperty(
        "org.pentaho.reporting.engine.classic.core.modules.output.pageable.xml.WriteResourceKeys")))
    {
