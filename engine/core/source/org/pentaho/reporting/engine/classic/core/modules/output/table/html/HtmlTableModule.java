...
public class HtmlTableModule extends AbstractModule
{
      ...
      throws ModuleInitializeException
  {
    ReportProcessTaskRegistry.getInstance().registerExportType
        (TABLE_HTML_STREAM_EXPORT_TYPE, StreamHtmlReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (TABLE_HTML_FLOW_EXPORT_TYPE, FlowHtmlReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (TABLE_HTML_PAGE_EXPORT_TYPE, PageableHtmlReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (ZIP_HTML_EXPORT_TYPE, ZipHtmpReportProcessTask.class);
  }
}
