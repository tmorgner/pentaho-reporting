...
public class XmlPageOutputProcessor extends AbstractPageableOutputProcessor
{
  ...
  public XmlPageOutputProcessor(final Configuration configuration,
                                final OutputStream outputStream)
  {
    this(outputStream, new XmlPageOutputProcessorMetaData(configuration));
  }

  public XmlPageOutputProcessor(final OutputStream outputStream,
