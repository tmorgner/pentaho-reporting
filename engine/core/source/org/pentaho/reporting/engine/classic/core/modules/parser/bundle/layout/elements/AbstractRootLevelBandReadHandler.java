...
public class AbstractRootLevelBandReadHandler extends AbstractXmlReadHandler
{
  ...
  private ArrayList subReportReadHandler;
  private AbstractRootLevelBand element;

  public AbstractRootLevelBandReadHandler(final String elementType) throws ParseException
  {
    this.subReportReadHandler = new ArrayList();
    this.contentReadHandler = new RootLevelContentReadHandler(elementType);
  }
