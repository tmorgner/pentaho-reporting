...
public class GroupedMetaDataComparator implements Comparator
{
  ...
  {
    final MetaData metaData1 = (MetaData) o1;
    final MetaData metaData2 = (MetaData) o2;
    ...
    final String dn1 = metaData1.getDisplayName(locale);
    final String dn2 = metaData2.getDisplayName(locale);
