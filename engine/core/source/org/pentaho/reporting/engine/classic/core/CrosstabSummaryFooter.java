...
import org.pentaho.reporting.engine.classic.core.filter.types.bands.CrosstabSummaryFooterType;
 ...
 */
public class CrosstabSummaryFooter extends Band implements RootLevelBand
{
  /**
   ...
   */
  public CrosstabSummaryFooter()
  {
    setElementType(new CrosstabSummaryFooterType());
  ...
  {
    return CrosstabSummaryFooter.EMPTY_SUB_REPORTS;
  }
