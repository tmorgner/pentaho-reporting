...
public class ExcelTableContentProducer extends TableContentProducer
{
  ...
  protected void collectSheetStyleData(final RenderBox box)
  {
    ...
    final Integer freezeTop = (Integer) box.getAttributes().getAttribute(AttributeNames.Excel.NAMESPACE, AttributeNames.Excel.FREEZING_TOP_POSITION);
    ...
    final Integer freezeLeft = (Integer) box.getAttributes().getAttribute(AttributeNames.Excel.NAMESPACE, AttributeNames.Excel.FREEZING_LEFT_POSITION);
