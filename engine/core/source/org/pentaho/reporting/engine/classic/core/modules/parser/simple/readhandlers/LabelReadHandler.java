...
public class LabelReadHandler extends AbstractTextElementReadHandler
{
  ...
  public void init(final RootXmlReadHandler rootXmlReadHandler, final String s, final String s1)
  {
    super.init(rootXmlReadHandler, s, s1);
    stringReadHandler.init(rootXmlReadHandler, s, s1);
  }

  public void characters(final char[] chars, final int i, final int i1) throws SAXException
  {
    stringReadHandler.characters(chars, i, i1);
  }
