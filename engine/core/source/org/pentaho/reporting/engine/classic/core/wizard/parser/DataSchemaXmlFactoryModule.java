 ...
 */
public class DataSchemaXmlFactoryModule implements XmlFactoryModule
{
  public DataSchemaXmlFactoryModule()
  {
  }
  ...
  public int getDocumentSupport(final XmlDocumentInfo documentInfo)
  {
    ...
    {
      if (ClassicEngineBoot.DATASCHEMA_NAMESPACE.equals(rootNamespace) == false)
      {
        return XmlFactoryModule.NOT_RECOGNIZED;
      }
      else if ("data-schema".equals(documentInfo.getRootElement()))
      {
  ...
  {
    return new DataSchemaRootElementHandler();
  }
  ...
  {
    return ClassicEngineBoot.DATASCHEMA_NAMESPACE;
  }
}
