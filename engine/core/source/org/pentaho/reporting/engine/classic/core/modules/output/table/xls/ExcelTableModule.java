...
public class ExcelTableModule extends AbstractModule
{
      ...
      throws ModuleInitializeException
  {
    ...
    ReportProcessTaskRegistry.getInstance().registerExportType
        (EXCEL_FLOW_EXPORT_TYPE, FlowExcelReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (EXCEL_PAGE_EXPORT_TYPE, PageableExcelReportProcessTask.class);

    ReportProcessTaskRegistry.getInstance().registerExportType
        (XLSX_STREAM_EXPORT_TYPE, StreamXExcelReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (XLSX_FLOW_EXPORT_TYPE, FlowXExcelReportProcessTask.class);
    ReportProcessTaskRegistry.getInstance().registerExportType
        (XLSX_PAGE_EXPORT_TYPE, PageableXExcelReportProcessTask.class);
  }
}
