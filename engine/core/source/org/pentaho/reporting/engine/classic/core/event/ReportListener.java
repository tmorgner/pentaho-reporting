...
/**
 * ReportListeners get informed whenever the state of a report changes. <P> You should be aware that most events occur
 * more than once.  For example, the reportStarted event will be triggered every time the report is regenerated. <P>
...
public interface ReportListener extends EventListener
{
  ...
  /**
   * Receives notification that report generation has started. <P> The event carries a ReportState.Started state. Use
   * this to prepare the report header.
   *
   * @param event The event.
   */
  ...
  /**
   * Receives notification that a new group has started. <P> The group can be determined by the report state's
  ...
  /**
   * Receives notification that a group is finished. <P> The group can be determined by the report state's
   * getCurrentGroup() function.
   *
   * @param event The event.
   */
  ...
  /**
   * Receives notification that a new row has been read. <P> This event is raised before an ItemBand is printed.
   *
   * @param event The event.
   */
