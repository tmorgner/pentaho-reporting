...
public class CrosstabOutputHandler implements GroupOutputHandler
{
                           ...
                           final ReportEvent event) throws ReportProcessingException
  {
    ...
    outputFunction.startCrosstabLayout();
    ...
    renderer.add(b, outputFunction.getRuntime(), event.getState().getProcessKey());
    outputFunction.addSubReportMarkers(renderer.endSection());

    renderer.startGroupBody(groupBody);
  }
                            ...
                            final ReportEvent event) throws ReportProcessingException
  {
    ...
    outputFunction.endCrosstabLayout();
  }
