...
public class MetaDataFunction implements Function
{
                                ...
                                final ParameterCallback parameters) throws EvaluationException
  {
    ...
    final String metaNamespace = context.getTypeRegistry().convertToText(parameters.getType(1), parameters.getValue(1));
    final String metaName = context.getTypeRegistry().convertToText(parameters.getType(2), parameters.getValue(2));
    final Class type;
    if (parameterCount == 4)
    {
      final String typeStr = context.getTypeRegistry().convertToText(parameters.getType(3), parameters.getValue(3));
