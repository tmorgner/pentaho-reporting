...
public class SpatialStyleReadHandler extends AbstractXmlReadHandler implements StyleReadHandler
{
  ...
  protected void startParsing(final Attributes atts) throws SAXException
  {
    ...
    if (posX != null)
    {
      styleSheet.setStyleProperty(ElementStyleKeys.POS_X, new Float(ReportParserUtil.parseRelativeFloat
    ...
    if (posY != null)
    {
      styleSheet.setStyleProperty(ElementStyleKeys.POS_Y, new Float(ReportParserUtil.parseRelativeFloat
    ...
    if (width != null)
    {
      styleSheet.setStyleProperty(ElementStyleKeys.WIDTH, new Float(ReportParserUtil.parseRelativeFloat
    ...
    if (height != null)
    {
      styleSheet.setStyleProperty(ElementStyleKeys.HEIGHT, new Float(ReportParserUtil.parseRelativeFloat
