 ...
 */
public class DefaultExpressionPropertyCore implements ExpressionPropertyCore
{
  ...
  public String[] getReferencedFields(final ExpressionPropertyMetaData metaData,
  ...
  public String[] getReferencedGroups(final ExpressionPropertyMetaData metaData,
                                      final Expression expression,
                                      final Object attributeValue)
  {
    if (expression == null)
  ...
  public String[] getReferencedElements(final ExpressionPropertyMetaData metaData,
                                        final Expression expression,
                                        final Object attributeValue)
  {
    if (expression == null)
  ...
  public ResourceReference[] getReferencedResources(final ExpressionPropertyMetaData metaData,
                                                    final Expression expression,
                                                    final Object attributeValue,
