...
public class ContentRootElementHandler extends AbstractXmlReadHandler
{
      ...
      if (key.getParent() != null)
      {
        ...
        try
        {
              ...
              (versionMajorRaw == 0 && versionMinorRaw == 0 && versionPatchRaw == 0))
          {
            ...
            getRootHandler().setHelperObject("prpt-spec-version", ClassicEngineBoot.computeVersionId(3, 8, 0));
          }
          else
          {
            ...
            getRootHandler().setHelperObject("prpt-spec-version",
  ...
  protected void doneParsing() throws SAXException
  {
    ...
    final Object definedCompatLevel =
        report.getAttribute(AttributeNames.Internal.NAMESPACE, AttributeNames.Internal.COMAPTIBILITY_LEVEL);
    if (definedCompatLevel instanceof Integer == false)
    {
      final Object specRaw = getRootHandler().getHelperObject("prpt-spec-version");
      Integer x = ClassicEngineBoot.computeVersionId(999, 999, 999);
      if (x.equals(specRaw) == false)
      {
        report.setAttribute
            (AttributeNames.Internal.NAMESPACE, AttributeNames.Internal.COMAPTIBILITY_LEVEL, specRaw);
      }
    }
  }
