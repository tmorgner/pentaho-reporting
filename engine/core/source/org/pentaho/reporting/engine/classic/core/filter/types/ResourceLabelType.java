 ...
 */
public class ResourceLabelType implements ElementType
{
  ...
  public ElementMetaData getMetaData()
  {
    if (elementType == null)
    {
      elementType = ElementTypeRegistry.getInstance().getElementType("resource-label");
    }
    return elementType;
  }
  ...
  public Object getDesignValue(final ExpressionRuntime runtime, final Element element)
  {
    ...
    final String resourceKey = resourceKeyRaw == null ? "<null>" : resourceKeyRaw.toString();
    return resourceKey;
  }
  ...
  public Object getValue(final ExpressionRuntime runtime, final Element element)
  {
    ...
    catch (Exception e)
    {
      ...
      ResourceLabelType.logger.warn
          ("Failed to retrive the value for resource-bundle " + resourceId + " with key " + resourceKey);
    }
