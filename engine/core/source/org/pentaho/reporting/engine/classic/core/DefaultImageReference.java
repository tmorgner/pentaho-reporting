    ...
    implements Serializable, URLImageContainer, LocalImageContainer
{
   ...
   * @deprecated This method auto-creates a new resource-manager for each image and therefore possibly prevents
   *             effective caching. Use the Resource-accepting constructor instead.
   */
