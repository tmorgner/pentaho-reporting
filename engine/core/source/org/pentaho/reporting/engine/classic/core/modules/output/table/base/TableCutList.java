...
//    accessLogWriter.println("put - " + System.currentTimeMillis() + " - " + key);
  ...
  public static int linearSearch(final long[] array, final long key, final int start, final int end)
  {
  ...
  public static int binarySearch(final long[] array, final long key, final int start, final int end)
  {
//    int itCount = 0;
    int low = start;
    int high = end - 1;
