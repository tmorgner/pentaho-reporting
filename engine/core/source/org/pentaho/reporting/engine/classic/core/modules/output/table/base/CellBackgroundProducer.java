...
public class CellBackgroundProducer extends IterateStructuralProcessStep
{
                                ...
                                final boolean unalignedPagebands)
  {
    ...
    this.fastCellBackgroundProducerMode = "true".equals(ClassicEngineBoot.getInstance().getGlobalConfig().getConfigProperty
                                            ...
                                            final RenderBox contentBox)
  {
    ...
    while (p != null)
    {
      final int nodeType = p.getNodeType();
      if (nodeType == LayoutNodeTypes.TYPE_BOX_SECTION)
      {
        seenSectionBox = true;
      }
      if (seenSectionBox)
