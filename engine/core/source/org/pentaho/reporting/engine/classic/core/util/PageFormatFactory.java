...
public final class PageFormatFactory
{
  ...
  {
    logger.debug("PageFormat: Width: " + pf.getWidth() + " Height: " + pf.getHeight());
    logger.debug("PageFormat: Image: X " + pf.getImageableX()
        + " Y " + pf.getImageableY()
        + " W: " + pf.getImageableWidth()
        + " H: " + pf.getImageableHeight());
    logger.debug("PageFormat: Margins: X " + pf.getImageableX()
        + " Y " + pf.getImageableY()
  ...
  {
    logger.debug("Paper: Width: " + pf.getWidth() + " Height: " + pf.getHeight());
    logger.debug("Paper: Image: X " + pf.getImageableX()
        + " Y " + pf.getImageableY()
        + " H: " + pf.getImageableHeight()
        + " W: " + pf.getImageableWidth());
  }
