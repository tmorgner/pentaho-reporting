...
public class ElementStyleKeys
{
   ...
   * @deprecated
   */
  public static final StyleKey BORDER_TOP_RIGHT_RADIUS = StyleKey.getStyleKey("border-top-right-radius",
      Dimension2D.class, true, false);
  /**
   * @deprecated
   */
  public static final StyleKey BORDER_TOP_LEFT_RADIUS = StyleKey.getStyleKey("border-top-left-radius",
      Dimension2D.class, true, false);
  /**
   * @deprecated
   */
  public static final StyleKey BORDER_BOTTOM_RIGHT_RADIUS = StyleKey.getStyleKey("border-bottom-right-radius",
      Dimension2D.class, true, false);
  /**
   * @deprecated
   */
  public static final StyleKey BORDER_BOTTOM_LEFT_RADIUS = StyleKey.getStyleKey("border-bottom-left-radius",
      Dimension2D.class, true, false);
