...
/**
 * A worker that converts raw-objects into rich-text objects. The worker expects either a byte-array, a
 * char-array, a string or a native Document and returns the converted value (or the value unchanged if its
