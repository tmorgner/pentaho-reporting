...
public class DefaultElementMetaData
    extends AbstractMetaData implements ElementMetaData
{
  ...
  public StyleMetaData[] getStyleDescriptions()
  {
    if (stylesArray == null)
    {
      stylesArray = (StyleMetaData[]) styles.values().toArray(new StyleMetaData[styles.size()]);
    }
    return stylesArray;
  }
  ...
  public StyleMetaData getStyleDescription(final StyleKey name)
  {
    ...
    return (StyleMetaData) styles.get(name);
  }
