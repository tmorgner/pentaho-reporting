...
public class PasswordEncryptionService
{
  ...
  private PasswordEncryptionService()
  {
    ...
    final String configProperty = ClassicEngineBoot.getInstance().getGlobalConfig().getConfigProperty
            (PasswordEncryptionServiceProvider.class.getName());
    provider = (PasswordEncryptionServiceProvider) ObjectUtilities.loadAndInstantiate
        (configProperty, PasswordEncryptionService.class, PasswordEncryptionServiceProvider.class);
    if (provider == null)
    {
