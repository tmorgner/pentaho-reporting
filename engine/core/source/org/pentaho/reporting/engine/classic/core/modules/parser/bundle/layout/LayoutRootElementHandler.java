...
public class LayoutRootElementHandler extends AbstractElementReadHandler
{
  ...
  private ArrayList layoutPreprocessorHandlers;
  ...
  {
    layoutPreprocessorHandlers = new ArrayList();
  }
  ...
  protected void startParsing(final Attributes attrs) throws SAXException
  {
    ...
    initialize(report.getElementTypeName());
  ...
  protected void doneParsing() throws SAXException
  {
    ...
    {
      final LayoutPreprocessorReadHandler handler =
          (LayoutPreprocessorReadHandler) layoutPreprocessorHandlers.get(i);
    ...
    if (rootGroupReadHandler != null)
    {
      report.setRootGroup(rootGroupReadHandler.getGroup());
    }
    else if (crosstabReadHandler != null)
    {
      report.setRootGroup(crosstabReadHandler.getGroup());
    }
    if (reportFooterReadHandler != null)
    {
