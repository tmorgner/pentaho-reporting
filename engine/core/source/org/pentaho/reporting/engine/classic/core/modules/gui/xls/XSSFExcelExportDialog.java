 ...
 * <p/>
 * The main method to call the dialog is {@link org.pentaho.reporting.engine.classic.core.modules.gui.xls.XSSFExcelExportDialog#performQueryForExport(org.pentaho.reporting.engine.classic.core.MasterReport ,
...
public class XSSFExcelExportDialog extends AbstractExportDialog
{
  ...
  private static final String XLS_FILE_EXTENSION = ".xlsx"; //$NON-NLS-1$
  ...
  protected void performSelectFile()
  {
    ...
    if (option == JFileChooser.APPROVE_OPTION)
    {
      ...
      // Test if ends on xls
      if (StringUtils.endsWithIgnoreCase(selFileName, XSSFExcelExportDialog.XLS_FILE_EXTENSION) == false)
      {
        selFileName = selFileName + XSSFExcelExportDialog.XLS_FILE_EXTENSION;
      }
