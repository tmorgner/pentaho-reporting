 ...
 */
public final class ContentPlaceholderRenderBox extends BlockRenderBox
{
  private InstanceID contentId;


  public ContentPlaceholderRenderBox(final StyleSheet styleSheet,
                                     final InstanceID instanceID,
                                     final BoxDefinition boxDefinition,
                                     final ElementType elementType,
                                     final ReportAttributeMap attributes,
                                     final ReportStateKey stateKey,
                                     final InstanceID contentId)
  {
  ...
  {
    return LayoutNodeTypes.TYPE_BOX_CONTENTPLACEHOLDER;
  }
