...
public class ElementReadHandler extends AbstractXmlReadHandler
{
  ...
  private ArrayList styleHandlers;
  ...
  protected void startParsing(final Attributes attrs) throws SAXException
  {
    ...
    container = "true".equals(attrs.getValue(getUri(), "container"));
  ...
  protected void doneParsing() throws SAXException
  {
    ...
    {
      final AttributeReadHandler handler = (AttributeReadHandler) attributeHandlers.get(i);
  ...
  public Object getObject() throws SAXException
  {
    return new DefaultElementMetaData
        (name, bundleName, "element.", expert, preferred, hidden, deprecated, container,
