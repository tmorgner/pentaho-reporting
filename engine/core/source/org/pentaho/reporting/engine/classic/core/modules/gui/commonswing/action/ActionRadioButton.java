...
/**
 * The ActionRadioButton is used to connect an Action and its properties to a JRadioButton. This functionality is
 * already implemented in JDK 1.3 but needed for JDK 1.2.2 compatibility.
 *
...
public class ActionRadioButton extends JRadioButton
{
  ...
  private class ActionEnablePropertyChangeHandler implements PropertyChangeListener
  {
    ...
    public void propertyChange(final PropertyChangeEvent event)
    {
      ...
      {
        ActionRadioButton.logger.warn("Error on PropertyChange in ActionButton: ", e);// NON-NLS
      }
    }
  }
  ...
  /**
   * Enables and disables this button and if an action is assigned to this button the propertychange is forwarded to the
   * assigned action.
   *
   ...
   * <p/>
   * <ul> <li>NAME - specifies the button text <li>SMALL_ICON - specifies the buttons icon <li>MNEMONIC_KEY - specifies
   * the buttons mnemonic key <li>ACCELERATOR_KEY - specifies the buttons accelerator </ul>
   *
