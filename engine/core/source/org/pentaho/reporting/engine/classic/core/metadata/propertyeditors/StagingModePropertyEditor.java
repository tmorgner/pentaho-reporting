...
public class StagingModePropertyEditor implements PropertyEditor
{
  ...
  public void setValue(final Object value)
  {
    ...
    if (StagingMode.MEMORY.equals(value) ||
        StagingMode.TMPFILE.equals(value) ||
        StagingMode.THRU.equals(value))
    {
  ...
  {
    return new String[]{
        StagingMode.MEMORY.toString(), StagingMode.TMPFILE.toString(), StagingMode.THRU.toString(),
    };
  }
