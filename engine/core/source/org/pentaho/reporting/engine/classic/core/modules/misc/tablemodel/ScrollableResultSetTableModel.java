    ...
    implements CloseableTableModel, MetaTableModel
{
  ...
  /**
   * Just removes the word class from the start of the classname string McKoiDB version 0.92 was not able to properly
   * return classnames of resultset elements.
   *
