 ...
 */
public class NumberFieldType implements ElementType, RawDataSource
{
  ...
  public ElementMetaData getMetaData()
  {
    if (elementType == null)
    {
      elementType = ElementTypeRegistry.getInstance().getElementType("number-field");
    }
    return elementType;
  }
  ...
  {
    final NumberFieldType o = (NumberFieldType) super.clone();
    if (o.decimalFormat != null)
    {
      o.decimalFormat = (FastDecimalFormat) decimalFormat.clone();
    }
    return o;
  }
