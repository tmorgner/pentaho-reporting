...
public class ReportDefinitionWriter extends AbstractXMLDefinitionWriter
{
   ...
   * <p/>
   * <ul> <li>{@link ParserConfigWriter} to write the parser configuration;</li> <li>{@link ReportConfigWriter} to write
   * the report configuration;</li> <li>{@link StylesWriter} to write the templates;</li> <li>{@link
   * ReportDescriptionWriter} to write the report description;</li> <li>{@link FunctionsWriter} to write the function
   * definitions;</li> </ul>
   *
