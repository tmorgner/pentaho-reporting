...
public class DefaultParameterDefinition implements ModifiableReportParameterDefinition
{
  ...
  {
    return (ParameterDefinitionEntry[]) parameters.toArray(new ParameterDefinitionEntry[parameters.size()]);
  }

  public ParameterDefinitionEntry getParameterDefinition(final int parameter)
  {
    return (ParameterDefinitionEntry) parameters.get(parameter);
  }
  ...
  public Object clone() throws CloneNotSupportedException
  {
    ...
    def.parameters = (ArrayList) parameters.clone();
    def.attributeMap = (ReportAttributeMap) attributeMap.clone();
    return def;
  }
