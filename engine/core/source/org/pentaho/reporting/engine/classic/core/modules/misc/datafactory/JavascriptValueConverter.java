 ...
 * We shield ourselves via dynamic class loading. The javax.scripting API is a nightmare to
 * work with when it comes to converting values in and out of the context of the script.
 *
 * We have to rely on these hacks to make it work - luckily everyone is either using Sun's JDK
 * or OpenJDK these days (I hope).
 */
