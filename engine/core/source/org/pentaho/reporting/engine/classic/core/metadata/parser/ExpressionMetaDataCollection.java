 ...
 */
public class ExpressionMetaDataCollection
{
  ...
  public ExpressionMetaDataCollection(final ExpressionMetaData[] expressionMetaData)
  {
    ...
    this.expressionMetaData = (ExpressionMetaData[]) expressionMetaData.clone();
  }

  public ExpressionMetaData[] getExpressionMetaData()
  {
    return (ExpressionMetaData[]) expressionMetaData.clone();
  }
}
