 ...
 */
public class GlobalMetaDefinitionXmlFactoryModule implements XmlFactoryModule
{
  public GlobalMetaDefinitionXmlFactoryModule()
  {
  }
  ...
  {
    return new GlobalMetaDataReadHandler();
  }
