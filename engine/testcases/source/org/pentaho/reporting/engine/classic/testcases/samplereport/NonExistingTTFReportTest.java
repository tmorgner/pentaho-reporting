...
public class NonExistingTTFReportTest extends BaseTest {

  public void testNonExistingTTFReportInPdf() {
    String reportTemplateFilename = getReportDefinitionPath() + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/pdf/NonExistingTTFReport.pdf"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/NonExistingTTFReport.pdf"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/NonExistingTTFReportLogFilePdf.txt"; //$NON-NLS-1$
  ...
  public void testNonExistingTTFReportInHtml() {
    String reportTemplateFilename = getReportDefinitionPath() + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/html/NonExistingTTFReport.html"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/NonExistingTTFReport.html"; //$NON-NLS-1$
    //String logFile = reportOutputPath + "/NonExistingTTFReportLogFileHtml.txt"; //$NON-NLS-1$    
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testVariousTTFReportInExcel() {
    String reportTemplateFilename = getReportDefinitionPath() + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/xls/NonExistingTTFReport.xls"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/NonExistingTTFReport.xls"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/NonExistingTTFReportLogFileXls.txt"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testVariousTTFReportInCsv() {
    String reportTemplateFilename = getReportDefinitionPath() + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/csv/NonExistingTTFReport.csv"; //$NON-NLS-1$ 
    String outputFilename = getReportOutputPath() + "/NonExistingTTFReport.csv"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
