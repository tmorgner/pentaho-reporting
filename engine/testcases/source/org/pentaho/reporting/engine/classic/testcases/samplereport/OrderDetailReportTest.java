...
public class OrderDetailReportTest extends BaseTest {

  public void testOrderDetailReportInHtml() {
    String reportTemplateFilename = getReportDefinitionPath() + "/OrderDetailReport.xml"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/OrderDetailReportTest.html"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/html/OrderDetailReportTest.html"; //$NON-NLS-1$
    //String logFile = reportOutputPath + "/OrderDetailLogFileHtml.txt"; //$NON-NLS-1$    
  ...
  public void testOrderDetailReportInPdf() {
    String reportTemplateFilename = getReportDefinitionPath() + "/OrderDetailReport.xml"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/OrderDetailReportTest.pdf"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/pdf/OrderDetailReportTest.pdf"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/OrderDetailLogFilePdf.txt"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testOrderDetailReportInExcel() {
    String reportTemplateFilename = getReportDefinitionPath() + "/OrderDetailReport.xml"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/OrderDetailReportTest.xls"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/xls/OrderDetailReportTest.xls"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/OrderDetailLogFileExcel.txt"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testOrderDetailReportInCsv() {
    String reportTemplateFilename = getReportDefinitionPath() + "/OrderDetailReport.xml"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/OrderDetailReportTest.csv"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/csv/OrderDetailReportTest.csv"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
