...
public class MultipleInlineFormulasReportTest extends BaseTest {

  public void testMultipleInlineFormulasInPdf() {
    String reportTemplateFilename = getReportDefinitionPath() + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/pdf/MultipleInlineFormulasReportTest.pdf"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/MultipleInlineFormulasReportTest.pdf"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/MultipleInlineFormulasReportTestLogFilePdf.txt"; //$NON-NLS-1$
  ...
  public void testMultipleInlineFormulasInHtml() {
    String reportTemplateFilename = getReportDefinitionPath() + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/html/MultipleInlineFormulasReportTest.html"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/MultipleInlineFormulasReportTest.html"; //$NON-NLS-1$
    //String logFile = reportOutputPath + "/MultipleInlineFormulasReportTestLogFileHtml.txt"; //$NON-NLS-1$    
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testMultipleInlineFormulasInExcel() {
    String reportTemplateFilename = getReportDefinitionPath() + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/xls/MultipleInlineFormulasReportTest.xls"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/MultipleInlineFormulasReportTest.xls"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/MultipleInlineFormulasReportTestLogFileXls.txt"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testJFreeQuadForRegionInCsv() {
    String reportTemplateFilename = getReportDefinitionPath() + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/csv/MultipleInlineFormulasReportTest.csv"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/MultipleInlineFormulasReportTest.csv"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
