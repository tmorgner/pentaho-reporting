...
public class DynamicallyShowColumnsReportXMLTest extends XMLBaseTest {

	public void testDynamicallyShowColumnsReportUsingPageableOutput() {
     String reportTemplateFilename = reportDefinitionPath + "/dynamically_show_columns.xml"; //$NON-NLS-1$
     String inputFileName  = reportInputPath + "/xml/PageableDynamicallyShowColumnsReport.xml"; //$NON-NLS-1$ 
     String outputFilename = reportOutputPath + "/PageableDynamicallyShowColumnsReport.xml"; //$NON-NLS-1$
     String logFile = reportOutputPath + "/PageableDynamicallyShowColumnsReportLog.txt"; //$NON-NLS-1$
  ...
  public void testDynamicallyShowColumnsReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/dynamically_show_columns.xml"; //$NON-NLS-1$
    String inputFileName  = reportInputPath + "/xml/FlowTableDynamicallyShowColumnsReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableDynamicallyShowColumnsReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableDynamicallyShowColumnsReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
