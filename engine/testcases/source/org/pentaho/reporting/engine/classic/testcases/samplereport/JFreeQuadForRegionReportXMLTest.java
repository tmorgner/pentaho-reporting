...
public class JFreeQuadForRegionReportXMLTest extends XMLBaseTest {

  public void testJFreeQuadForRegionUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/JFreeQuadForRegion.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableJFreeQuadForRegionReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableJFreeQuadForRegionReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableJFreeQuadForRegionReportLog.txt"; //$NON-NLS-1$
  ...
  public void testJFreeQuadForRegionUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/JFreeQuadForRegion.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableJFreeQuadForRegionReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableJFreeQuadForRegionReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableJFreeQuadForRegionReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
