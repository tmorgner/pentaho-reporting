...
public class InvoiceReportXMLTest extends XMLBaseTest {

  public void testInvoiceReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Invoice.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableInvoiceReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableInvoiceReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableInvoiceReportLog.txt"; //$NON-NLS-1$
  ...
  public void testInvoiceReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Invoice.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableInvoiceReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableInvoiceReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableInvoiceReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
