...
public class CalculatedColumnsReportXMLTest extends XMLBaseTest {

  public void testCalculatedColumnsReportUsingPageableOutput() throws Exception {
    String reportTemplateFilename = reportDefinitionPath + "/calculated.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableCalculatedColumnReport.xml"; //$NON-NLS-1$
    String outputFilename = reportOutputPath + "/PageableCalculatedColumnReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableCalculatedColumnReportLog.txt"; //$NON-NLS-1$
  ...
  public void testCalculatedColumnsReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/calculated.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableCalculatedColumnReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableCalculatedColumnReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableCalculatedColumnReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
