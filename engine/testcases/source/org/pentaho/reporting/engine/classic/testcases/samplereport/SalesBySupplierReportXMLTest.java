...
public class SalesBySupplierReportXMLTest extends XMLBaseTest {

  public void testSalesBySupplierReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Sales_by_Supplier.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableSalesBySupplierReport.xml"; //$NON-NLS-1$    
    String outputFilename = reportOutputPath + "/PageableSalesBySupplierReport.xml"; //$NON-NLS-1$      
    String logFile = reportOutputPath + "/PageableSalesBySupplierReportLog.txt"; //$NON-NLS-1$
  ...
  public void testSalesBySupplierReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Sales_by_Supplier.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableSalesBySupplierReport.xml"; //$NON-NLS-1$    
    String outputFilename = reportOutputPath + "/FlowTableSalesBySupplierReport.xml"; //$NON-NLS-1$      
    String logFile = reportOutputPath + "/FlowTableSalesBySupplierReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
