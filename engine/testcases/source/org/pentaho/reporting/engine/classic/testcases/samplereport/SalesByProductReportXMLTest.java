...
public class SalesByProductReportXMLTest extends XMLBaseTest {

  public void testSalesByProductReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Sales_by_Product.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableSalesByProductReport.xml"; //$NON-NLS-1$    
    String outputFilename = reportOutputPath + "/PageableSalesByProductReport.xml"; //$NON-NLS-1$      
    String logFile = reportOutputPath + "/PageableSalesByProductReportLog.txt"; //$NON-NLS-1$
  ...
  public void testSalesByProductReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Sales_by_Product.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableSalesByProductReport.xml"; //$NON-NLS-1$    
    String outputFilename = reportOutputPath + "/FlowTableSalesByProductReport.xml"; //$NON-NLS-1$      
    String logFile = reportOutputPath + "/FlowTableSalesByProductReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
