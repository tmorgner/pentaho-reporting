...
import org.pentaho.reporting.engine.classic.core.testsupport.gold.StopWatch;
...
public class Prd4626Test extends TestCase
{
  ...
  public void testPdfPrinting() throws Exception
  {
    ...
    final Element topLabel = createDataItem("Top Label");
    topLabel.getStyle().setStyleProperty(ElementStyleKeys.POS_Y, 0f);
    final Element bottomLabel = createDataItem("Bottom Label");
