...
public class Pre85ReportTest extends BaseTest
{
  private static final String URLNAME = "org/pentaho/reporting/engine/classic/testcases/bugs/resource/Pre85Test.xml";

  public Pre85ReportTest()
  {
  }

  public static void testPre85Report() throws Exception
  {
    ...
    tableModel.setValueAt(new Integer(1), 0, 0);
    tableModel.setValueAt(new Integer(1), 1, 0);
    tableModel.setValueAt(new Integer(2), 2, 0);
    tableModel.setValueAt(new Integer(2), 3, 0);
    tableModel.setValueAt(new Integer(3), 4, 0);
    tableModel.setValueAt(new Integer(3), 5, 0);
    tableModel.setValueAt("A", 0, 1);
    tableModel.setValueAt("AA", 1, 1);
    tableModel.setValueAt("B", 2, 1);
