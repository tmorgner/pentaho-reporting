...
public class MultipleInlineForumulasReportXMLTest extends XMLBaseTest {

  public void testMultipleInlineForumulasReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableMultipleInlineFormulasReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableMultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableMultipleInlineFormulasReportLog.txt"; //$NON-NLS-1$
  ...
  public void testMultipleInlineForumulasReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/MultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableMultipleInlineFormulasReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableMultipleInlineFormulasReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableMultipleInlineFormulasReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
