 ...
 * @deprecated 
 */
public class FontNotExistCrashTest extends AbstractReportExecuteTest
{
  public FontNotExistCrashTest(String string)
  {
    super(string);
  }
  ...
  {
    final FontNotExistCrashTestHandler handler = new FontNotExistCrashTestHandler();
    try {
