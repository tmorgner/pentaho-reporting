...
public class IncomeStatementReportXMLTest extends XMLBaseTest {

  public void testIncomeStatementReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableIncomeStatementReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableIncomeStatementReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableIncomeStatementReportTestLog.txt"; //$NON-NLS-1$
  ...
  public void testIncomeStatementReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableIncomeStatementReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableIncomeStatementReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableIncomeStatementReportTestLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
