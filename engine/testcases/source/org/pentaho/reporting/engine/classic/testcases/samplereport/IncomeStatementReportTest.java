...
public class IncomeStatementReportTest extends BaseTest {

  public void testIncomeStatementReportInPdf() {
    String reportTemplateFilename = getReportDefinitionPath() + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/pdf/IncomeStatementReportTest.pdf"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/IncomeStatementReportTest.pdf"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/IncomeStatementReportTestLogFilePdf.txt"; //$NON-NLS-1$
  ...
  public void testIncomeStatementReportInHtml() {
    String reportTemplateFilename = getReportDefinitionPath() + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/html/IncomeStatementReportTest.html"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/IncomeStatementReportTest.html"; //$NON-NLS-1$
    //String logFile = reportOutputPath + "/IncomeStatementReportTestLogFileHtml.txt"; //$NON-NLS-1$    
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testIncomeStatementReportInExcel() {
    String reportTemplateFilename = getReportDefinitionPath() + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/xls/IncomeStatementReportTest.xls"; //$NON-NLS-1$
    String outputFilename = getReportOutputPath() + "/IncomeStatementReportTest.xls"; //$NON-NLS-1$
    String logFile = getReportOutputPath() + "/IncomeStatementReportTestLogFileXls.txt"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
  ...
  public void testIncomeStatementReportInCsv() {
    String reportTemplateFilename = getReportDefinitionPath() + "/IncomeStatementReport.xml"; //$NON-NLS-1$
    String inputFileName = getReportInputPath() + "/csv/IncomeStatementReportTest.csv"; //$NON-NLS-1$ 
    String outputFilename = getReportOutputPath() + "/IncomeStatementReportTest.csv"; //$NON-NLS-1$
    boolean isEqual = false;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
