...
public class NonExistingTTFReportXMLTest extends XMLBaseTest {

  public void testNonExistingTTFReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableNonExistingTTFReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableNonExistingTTFReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableNonExistingTTFReportLog.txt"; //$NON-NLS-1$
  ...
  public void testVariousTTFReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/NonExistingTTFReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableNonExistingTTFReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableNonExistingTTFReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableNonExistingTTFReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
