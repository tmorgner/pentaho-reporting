 ...
 */
public class Pre343Test extends BaseTest
{
  public Pre343Test()
  {
  }
 /**
  ...
  public URL getReportDefinitionSource()
  {
    return ObjectUtilities.getResourceRelative
        ("Pre343.xml", Pre343Test.class); //$NON-NLS-1$
  }

  public  void testPre112() throws ReportProcessingException, IOException, ReportDefinitionException
  {
    ClassicEngineBoot.getInstance().start();
    String outputFilename = getReportOutputPath() + "/report3.pdf"; //$NON-NLS-1$
    PdfReportUtil.createPDF(parseReport(getReportDefinitionSource()), outputFilename);
    assertTrue(true);
  }
}