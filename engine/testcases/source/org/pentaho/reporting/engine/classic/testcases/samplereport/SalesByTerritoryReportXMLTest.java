...
public class SalesByTerritoryReportXMLTest extends XMLBaseTest {

  public void testSalesByTerritoryReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/SalesByTerritoryReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableSalesByTerritoryReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableSalesByTerritoryReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableSalesByTerritoryReportLog.txt"; //$NON-NLS-1$
  ...
  public void testSalesByTerritoryReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/SalesByTerritoryReport.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableSalesByTerritoryReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableSalesByTerritoryReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableSalesByTerritoryReportLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
