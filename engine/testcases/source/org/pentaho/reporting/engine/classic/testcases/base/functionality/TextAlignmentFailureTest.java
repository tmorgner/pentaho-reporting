 ...
 * @deprecated
 */
public class TextAlignmentFailureTest extends AbstractReportExecuteTest
{
  public TextAlignmentFailureTest(String string)
  {
    super(string);
  }
  ...
  {
    final TextAlignmentFailureTestHandler handler = new TextAlignmentFailureTestHandler();
    performExportTest(handler);
  }
}
