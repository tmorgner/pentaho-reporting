...
public class InventoryListReportXMLTest extends XMLBaseTest {

  public void testIncomeStatementReportUsingPageableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Inventory_List.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/PageableInventoryListReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/PageableInventoryListReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/PageableInventoryListReportTestLog.txt"; //$NON-NLS-1$
  ...
  public void testIncomeStatementReportUsingFlowTableOutput() {
    String reportTemplateFilename = reportDefinitionPath + "/Inventory_List.xml"; //$NON-NLS-1$
    String inputFileName = reportInputPath + "/xml/FlowTableInventoryListReport.xml"; //$NON-NLS-1$ 
    String outputFilename = reportOutputPath + "/FlowTableInventoryListReport.xml"; //$NON-NLS-1$
    String logFile = reportOutputPath + "/FlowTableInventoryListReportTestLog.txt"; //$NON-NLS-1$
    List allDifferences = null;
    try {
      // Get the name of the report definition filename
      File reportDefinition = new File(reportTemplateFilename);
