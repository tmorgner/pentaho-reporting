...
//      System.out.println ("Parent: " + parentReportStateKey);
      ...
      final Element element = (Element) reportHeader.getElement(0); // this should be the chart
  ...
  public static class ValidateChartPreProcessor implements ReportPreProcessor
  {
