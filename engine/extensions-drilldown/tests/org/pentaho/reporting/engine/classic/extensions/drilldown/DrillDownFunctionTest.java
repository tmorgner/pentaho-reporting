...
public class DrillDownFunctionTest extends FormulaTestBase
{
  ...
  protected Object[][] createDataTest()
  {
    return new Object[][]{
        ...
        {"DRILLDOWN(\"local-analyzer\"; NA(); {\"name\"; \"test.xanalyzer\" | \"solution\"; \"steelwheels\" | \"path\"; \"analyzer\"})",
          "http://localhost:8080/pentaho/content/analyzer/viewer?command=open&action=test.xanalyzer&solution=steelwheels&path=analyzer" },
        {"DRILLDOWN(\"remote-analyzer\"; \"ssh://domain.example\"; {\"name\"; \"test.xanalyzer\" | \"solution\"; \"steelwheels\" | \"path\"; \"analyzer\"})",
          "ssh://domain.example/content/analyzer/viewer?command=open&action=test.xanalyzer&solution=steelwheels&path=analyzer" },
        ...
        {"DRILLDOWN(\"local-xdash\"; NA(); {\"name\"; \"test.xdash\" | \"solution\"; \"steelwheels\" | \"path\"; \"analyzer\"})",
          "http://localhost:8080/pentaho/content/dashboards?action_name=test.xdash&solution=steelwheels&path=analyzer"},
        {"DRILLDOWN(\"remote-xdash\"; \"ssh://domain.example\"; {\"name\"; \"test.xdash\" | \"solution\"; \"steelwheels\" | \"path\"; \"analyzer\"})",
          "ssh://domain.example/content/dashboards?action_name=test.xdash&solution=steelwheels&path=analyzer"},
    };
  }
