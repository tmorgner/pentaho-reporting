...
public class FontPropertyEditor implements PropertyEditor
{
  private class FontPropertiesHandler implements ChangeListener
  {
    ...
    public void stateChanged(final ChangeEvent e)
    {
      ...
      setValue(new Font(fontName, fontStyle, fontSize));
    }
  }
  ...
  {
    final Object oldValue = this.font;
    ...
    propertyChangeSupport.firePropertyChange(null, oldValue, font);
  }
