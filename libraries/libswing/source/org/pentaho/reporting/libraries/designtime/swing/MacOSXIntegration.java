...
public class MacOSXIntegration
{
  ...
  private static class MacOSApplicationListener implements InvocationHandler
  {
    ...
    private MacOSApplicationListener() throws Exception
    {
      ...
      final Method addListenerMethod = applicationClass.getDeclaredMethod("addApplicationListener", applicationListenerClass);
      final Object osxAdapterProxy = Proxy.newProxyInstance(MacOSXIntegration.class.getClassLoader(), new Class[]{applicationListenerClass}, this);
