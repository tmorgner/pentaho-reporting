 ...
 */
public class LocalFileModel extends SolutionFileModel
{
  ...
  public void refresh() throws IOException
  {
    ...
    final String service = configuration.getConfigProperty
        ("org.pentaho.reporting.libraries.pensol.LoadRepositoryDoc");
  ...
  public boolean createFolder(final FileName file) throws FileSystemException
  {
    ...
    try
    {
      ...
      final String urlMessage =
          config.getConfigProperty("org.pentaho.reporting.libraries.pensol.CreateNewFolder");
