  ...
  private class FunctionDescriptionUpdateHandler implements PropertyChangeListener, ActionListener
  {
    ...
    public void actionPerformed(final ActionEvent e)
    {
      ...
      for (int i = 0; i < count; i++)
      {
        ...
        final org.pentaho.reporting.libraries.formula.typing.Type type = selectedFunction.getParameterType(i);
...
//      putValue(Action.NAME, symbol);
  ...
  protected void init()
  {
    ...
    LibSwingUtil.positionDialogRelativeToParent(this, 0.5, 0.5);
  }

  private JComponent buildFormulaTextPanel()
  {
    final JToolBar operatorButtonPanel = createOperatorPanel();
    ...
    textPanel.add(operatorButtonPanel, gbc);
  ...
  protected JPanel createContentPane()
  {
    ...
    formulaPanel.add(functionSelectorPanel, BorderLayout.WEST);
    formulaPanel.add(functionInformationPanel, BorderLayout.SOUTH);
    formulaPanel.add(functionPanel, BorderLayout.CENTER);
    return formulaPanel;
  }
  ...
  public String editFormula(final String formula, final FieldDefinition[] fields)
  {
    ...
    final String formulaText = getFormulaText();
