...
public class ResourceBundleSupport
{
   ...
   * Returns the keystroke stored at the given resourcebundle key.
   * <p/>
   * The keystroke will be composed of a simple key press and a keystroke mask pattern. The pattern
   * should be specified via the words "shift", "alt", "ctrl", "meta" or "menu". Menu should be used
   * to reference the platform specific menu shortcut. For the sake of safety, menu should only be
   * combined with "shift" and/or "alt" for menu keystrokes.
   * <p/>
   * The keystrokes character key should be either the symbolic name of one of
   * the KeyEvent.VK_* constants or the character for that key.
   * <p/>
