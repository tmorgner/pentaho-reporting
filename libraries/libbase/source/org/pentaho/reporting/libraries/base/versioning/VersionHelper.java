...
public class VersionHelper
{
  ...
  {
    private WeakHashMap<String, Manifest> manifests;
    private WeakHashMap<String, Manifest> manifestsByURL;

    public ManifestCache()
    {
      manifests = new WeakHashMap<String, Manifest>();
      manifestsByURL = new WeakHashMap<String, Manifest>();
    }
