...
public class SecurePasswordEncryption
{
  ...
  protected void appendAsHexString(final byte[] encryptedData, final StringBuffer b)
  {
  ...
  protected byte[] intToByte(final int value)
  {
  ...
  byte[] stringToBytes(final String password)
  ...
  protected int bytesToInt(final byte[] data, final int offset)
  {
    int retval = 0;
