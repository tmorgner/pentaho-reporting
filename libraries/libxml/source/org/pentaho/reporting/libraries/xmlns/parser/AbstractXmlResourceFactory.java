...
public abstract class AbstractXmlResourceFactory implements ResourceFactory
{
  ...
  protected RootXmlReadHandler createRootHandler(final ResourceManager manager,
                                                 ...
                                                 final long version)
  {
    return new MultiplexRootElementHandler(manager, targetKey,
   ...
   * @deprecated You should not depend on the MultiplexRootElementHandler.
   */
                                    ...
                                    final Class createdType)
  {
    ...
    {
      return createResource(targetKey, (MultiplexRootElementHandler) handler, createdProduct, createdType);
    }
    return new CompoundResource
        (targetKey, handler.getDependencyCollector(), createdProduct, createdType);
  }
