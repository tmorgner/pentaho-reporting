...
public class DirectoryResourceBundleLoader implements ResourceBundleLoader
{
   ...
   *                                      reason.
   */
  public ResourceKey deriveKey(final ResourceKey parent, final String path, final Map factoryKeys) throws ResourceKeyCreationException
  {
    ...
    if (path != null)
    {
      if ((path.length() > 0 && path.charAt(0) == '/') == false)
      {
