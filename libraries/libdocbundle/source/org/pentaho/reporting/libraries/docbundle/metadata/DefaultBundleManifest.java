...
public class DefaultBundleManifest implements BundleManifest, Serializable, Cloneable
{
  ...
  private AttributeMap entryAttributes;
  ...
  public DefaultBundleManifest()
  {
    ...
    entryAttributes = new AttributeMap();
  }
  ...
  {
    return (String) entryAttributes.getAttribute(entryName, attributeName);
  }
  ...
  public Object clone() throws CloneNotSupportedException
  {
    ...
    manifest.entryAttributes = (AttributeMap) entryAttributes.clone();
    return manifest;
  }
}
