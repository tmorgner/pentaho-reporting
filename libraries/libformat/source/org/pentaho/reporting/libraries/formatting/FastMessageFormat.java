...
public class FastMessageFormat implements FastFormat
{
  ...
  public FastMessageFormat(final String pattern, final Locale locale)
  {
    ...
    final ArrayList indexMappings = new ArrayList();
    ...
    this.constantTexts = (String[]) constants.toArray(new String[constants.size()]);
    this.argumentMapping = new int[indexMappings.size()];
    for (int i = 0; i < indexMappings.size(); i++)
    {
      final Integer integer = (Integer) indexMappings.get(i);
      argumentMapping[i] = integer.intValue();
    }
    this.subFormats = (FastFormat[]) patterns.toArray(new FastFormat[patterns.size()]);
  ...
  public void setLocale(final Locale locale)
  {
    ...
    {
      final FastFormat subFormat = subFormats[i];
      if (subFormat != null)
      {
        subFormat.setLocale(locale);
      }
    }
  }
  ...
  public String format(final Object parameters)
  {
    ...
    final StringBuilder buffer = new StringBuilder(sizeHint);
    for (int i = 0; i < subFormats.length; i++)
    {
...
//  {
//    new FastMessageFormat("A test {0} asdasd");
//    new FastMessageFormat("A test {0}");
//    new FastMessageFormat("{0} asdasd");
//    new FastMessageFormat("A test \\{{0} asdasd");
//    new FastMessageFormat("A test {asdasd{0}} asdasd");
//  }
}
