...
/**
 * A fast-format is a wrapper around the existing java.text.Formatter objects. The fast-format reduces the
 * possible interactions with the wrapped formatter and therefore allows to treat the formatter as
 * some sort of immutable object. This later simplifies cloning, as now the formatter and all of its
 * internal objects no longer need to be cloned.
 *
...
{
  /**
   * Updates the locale of the formatter.
   *
